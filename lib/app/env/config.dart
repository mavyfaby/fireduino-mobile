...
const String webServerApi =  "http://192.168.1.145:4000/mobile"; //"https://fireduino.azurewebsites.net/mobile";
const String socketServerApi = "http://fireduino-ws.azurewebsites.net";
